...
;* Date/Time created: Thu Jun  8 10:15:08 2017                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("/data/home/in4342-11/Shared-RPi/phil/psychic-system/ESLab_Assign02_Group11/code/instrumented_pool_notify/dsp")
;*****************************************************************************
;* CINIT RECORDS                                                             *
;*****************************************************************************
	.sect	".cinit"
...
_count$2:	.usect	".far",4,4
;	/data/bbToolChain/usr/local/share/c6000/bin/opt6x /tmp/187844E46mu /tmp/18784kXp2N8 
	.sect	".text"
	.clink
	.global	_sum_dsp
...
$C$DW$45	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$45, DW_AT_name("/data/home/in4342-11/Shared-RPi/phil/psychic-system/ESLab_Assign02_Group11/code/instrumented_pool_notify/dsp/task.asm:$C$L3:1:1496916908")
...
$C$DW$47	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$47, DW_AT_name("/data/home/in4342-11/Shared-RPi/phil/psychic-system/ESLab_Assign02_Group11/code/instrumented_pool_notify/dsp/task.asm:$C$L1:1:1496916908")
...
;          EXCLUSIVE CPU CYCLES: 17
           ...
           MVKH    .S1     _buf,A5
           ADD     .L1     1,A3,A3           ; |163| 
           CMPLT   .L1     A3,2,A0           ; |168| 

   [!A0]   STW     .D2T1   A6,*B5            ; |169| 
||         MVKL    .S2     _SEM_post,B5      ; |171| 

           MVKH    .S2     _SEM_post,B5      ; |171| 
$C$DW$53	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$53, DW_AT_TI_return
           CALLRET .S2     B5                ; |171| 
           STW     .D1T1   A3,*A4            ; |163| 
           CMPEQ   .L2X    A3,1,B0           ; |164| 
   [ B0]   STW     .D1T1   A6,*A5            ; |165| 
           ADD     .L1X    4,B4,A4           ; |171| 
	.dwpsn	file "task.c",line 175,column 1,is_stmt
           NOP             1
$C$RL0:    ; CALL-RETURN OCCURS {_SEM_post} {0}  ; |171| 
	.dwattr $C$DW$49, DW_AT_TI_end_file("task.c")
	.dwattr $C$DW$49, DW_AT_TI_end_line(0xaf)
...
$C$DW$54	.dwtag  DW_TAG_subprogram, DW_AT_name("Task_execute")
	...
	.dwattr $C$DW$54, DW_AT_frame_base[DW_OP_breg31 32]
...
;          EXCLUSIVE CPU CYCLES: 6
           MVKL    .S1     _SEM_pend,A3      ; |117| 
           MVKH    .S1     _SEM_pend,A3      ; |117| 

           MVKL    .S1     _count$1,A11
...
;*----------------------------------------------------------------------------*
$C$L7:    
$C$DW$L$_Task_execute$2$B:
;          EXCLUSIVE CPU CYCLES: 3
           ADDKPC  .S2     $C$RL1,B3,1       ; |117| 

           MV      .L2     B10,B4            ; |117| 
||         MV      .L1     A10,A4            ; |117| 

$C$RL1:    ; CALL OCCURS {_SEM_pend} {0}     ; |117| 
$C$DW$L$_Task_execute$2$E:
;** --------------------------------------------------------------------------*
$C$DW$L$_Task_execute$3$B:
;          EXCLUSIVE CPU CYCLES: 17
           MVKL    .S1     _BCACHE_inv,A3    ; |120| 
           MVKH    .S1     _BCACHE_inv,A3    ; |120| 
           LDW     .D2T2   *B11,B4           ; |120| 
$C$DW$57	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$57, DW_AT_TI_call
           ...
           MVK     .L1     0x1,A6            ; |120| 
$C$RL2:    ; CALL OCCURS {_BCACHE_inv} {0}   ; |120| 
           MVKL    .S2     _NOTIFY_notify,B5 ; |126| 

           MVKH    .S2     _NOTIFY_notify,B5 ; |126| 
||         LDW     .D1T1   *A11,A3           ; |126| 
...
$C$RL3:    ; CALL OCCURS {_NOTIFY_notify} {0}  ; |126| 
$C$DW$L$_Task_execute$3$E:
;** --------------------------------------------------------------------------*
...
$C$DW$59	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$59, DW_AT_name("_SEM_pend")
	.dwattr $C$DW$59, DW_AT_TI_call
           CALL    .S2X    A3                ; |117| 
	.dwpsn	file "task.c",line 129,column 0,is_stmt
           NOP             2
           ; BRANCH OCCURS {$C$L7}           ; |129| 
$C$DW$L$_Task_execute$4$E:

$C$DW$60	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$60, DW_AT_name("/data/home/in4342-11/Shared-RPi/phil/psychic-system/ESLab_Assign02_Group11/code/instrumented_pool_notify/dsp/task.asm:$C$L7:1:1496916908")
	.dwattr $C$DW$60, DW_AT_TI_begin_file("task.c")
	.dwattr $C$DW$60, DW_AT_TI_begin_line(0x73)
	.dwattr $C$DW$60, DW_AT_TI_end_line(0x81)
$C$DW$61	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$61, DW_AT_low_pc($C$DW$L$_Task_execute$2$B)
	.dwattr $C$DW$61, DW_AT_high_pc($C$DW$L$_Task_execute$2$E)
$C$DW$62	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$62, DW_AT_low_pc($C$DW$L$_Task_execute$3$B)
	.dwattr $C$DW$62, DW_AT_high_pc($C$DW$L$_Task_execute$3$E)
$C$DW$63	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$63, DW_AT_low_pc($C$DW$L$_Task_execute$4$B)
	.dwattr $C$DW$63, DW_AT_high_pc($C$DW$L$_Task_execute$4$E)
	.dwendtag $C$DW$60
...
$C$DW$64	.dwtag  DW_TAG_subprogram, DW_AT_name("Task_delete")
	.dwattr $C$DW$64, DW_AT_low_pc(_Task_delete)
	.dwattr $C$DW$64, DW_AT_high_pc(0x00)
	.dwattr $C$DW$64, DW_AT_TI_symbol_name("_Task_delete")
	.dwattr $C$DW$64, DW_AT_external
	.dwattr $C$DW$64, DW_AT_type(*$C$DW$T$22)
	.dwattr $C$DW$64, DW_AT_TI_begin_file("task.c")
	.dwattr $C$DW$64, DW_AT_TI_begin_line(0x85)
	.dwattr $C$DW$64, DW_AT_TI_begin_column(0x05)
	.dwattr $C$DW$64, DW_AT_frame_base[DW_OP_breg31 16]
	.dwattr $C$DW$64, DW_AT_TI_skeletal
	.dwpsn	file "task.c",line 134,column 1,is_stmt,address _Task_delete
$C$DW$65	.dwtag  DW_TAG_formal_parameter, DW_AT_name("info")
	.dwattr $C$DW$65, DW_AT_TI_symbol_name("_info")
...
;          EXCLUSIVE CPU CYCLES: 9
           MVKL    .S1     _NOTIFY_unregister,A3 ; |140| 
           MVKH    .S1     _NOTIFY_unregister,A3 ; |140| 
           MVKL    .S2     _Task_notify,B6   ; |140| 
$C$DW$66	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$66, DW_AT_low_pc(0x00)
	.dwattr $C$DW$66, DW_AT_name("_NOTIFY_unregister")
	.dwattr $C$DW$66, DW_AT_TI_call
           CALL    .S2X    A3                ; |140| 
           STW     .D2T2   B13,*SP--(8)      ; |134| 
           MVKH    .S2     _Task_notify,B6   ; |140| 
           MV      .L1     A4,A8             ; |134| 
           ZERO    .L2     B4                ; |140| 

           STDW    .D2T1   A11:A10,*SP--     ; |134| 
||         MV      .L1     A4,A11            ; |134| 
||         MV      .L2     B3,B13            ; |134| 
||         ADDKPC  .S2     $C$RL4,B3,0       ; |140| 
||         MVK     .S1     0x5,A6            ; |140| 
||         MVK     .D1     0x1,A4            ; |140| 

$C$RL4:    ; CALL OCCURS {_NOTIFY_unregister} {0}  ; |140| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 8
           MVKL    .S2     _MEM_free,B5      ; |147| 

           MVKH    .S2     _MEM_free,B5      ; |147| 
||         MVKL    .S1     _DDR2,A3

$C$DW$67	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$67, DW_AT_low_pc(0x00)
	.dwattr $C$DW$67, DW_AT_name("_MEM_free")
...
||         LDW     .D1T1   *A3,A4            ; |147| 
           ...
           ADDKPC  .S2     $C$RL5,B3,2       ; |147| 

           MV      .L2X    A11,B4            ; |147| 
||         MVK     .S1     0x28,A6           ; |147| 

$C$RL5:    ; CALL OCCURS {_MEM_free} {0}     ; |147| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 7
           MV      .L2     B13,B3            ; |153| 
...
||         LDDW    .D2T1   *++SP,A11:A10     ; |153| 
           ...
           LDW     .D2T2   *++SP(8),B13      ; |153| 
	.dwpsn	file "task.c",line 153,column 1,is_stmt
           NOP             4
           ; BRANCH OCCURS {B3}              ; |153| 
	.dwattr $C$DW$64, DW_AT_TI_end_file("task.c")
	.dwattr $C$DW$64, DW_AT_TI_end_line(0x99)
...
$C$DW$69	.dwtag  DW_TAG_subprogram, DW_AT_name("Task_create")
	.dwattr $C$DW$69, DW_AT_low_pc(_Task_create)
	.dwattr $C$DW$69, DW_AT_high_pc(0x00)
	.dwattr $C$DW$69, DW_AT_TI_symbol_name("_Task_create")
	.dwattr $C$DW$69, DW_AT_external
	.dwattr $C$DW$69, DW_AT_type(*$C$DW$T$22)
	.dwattr $C$DW$69, DW_AT_TI_begin_file("task.c")
	.dwattr $C$DW$69, DW_AT_TI_begin_line(0x19)
	.dwattr $C$DW$69, DW_AT_TI_begin_column(0x05)
	.dwattr $C$DW$69, DW_AT_frame_base[DW_OP_breg31 24]
	.dwattr $C$DW$69, DW_AT_TI_skeletal
	.dwpsn	file "task.c",line 26,column 1,is_stmt,address _Task_create
$C$DW$70	.dwtag  DW_TAG_formal_parameter, DW_AT_name("infoPtr")
	.dwattr $C$DW$70, DW_AT_TI_symbol_name("_infoPtr")
	.dwattr $C$DW$70, DW_AT_type(*$C$DW$T$76)
...
$C$DW$71	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$71, DW_AT_name("_MEM_valloc")
...
||         MVKH    .S1     _DDR2,A4
           ...
           MVK     .S2     0x28,B4           ; |34| 
           MV      .L2     B3,B11            ; |26| 
           ADDKPC  .S2     $C$RL6,B3,0       ; |34| 

           ZERO    .L1     A6                ; |34| 
||         ZERO    .L2     B6                ; |34| 

$C$RL6:    ; CALL OCCURS {_MEM_valloc} {0}   ; |34| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 14
...
||         ADDKPC  .S2     $C$RL7,B3,0       ; |61| 

$C$RL7:    ; CALL OCCURS {_NOTIFY_register} {0}  ; |61| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 7
...
|| [!A0]   MVK     .D1     0x5,A6            ; |78| 
   ...
   [!A0]   MVKH    .S1     _NOTIFY_notify,A3 ; |78| 
           ; BRANCHCC OCCURS {$C$L9}         ; |61| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 5
   [ A0]   BNOP    .S1     $C$L10,4          ; |76| 
;** --------------------------------------------------------------------------*
$C$L8:    
;          EXCLUSIVE CPU CYCLES: 1
...
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 5
           ADDKPC  .S2     $C$RL8,B3,4       ; |78| 
$C$RL8:    ; CALL OCCURS {_NOTIFY_notify} {0}  ; |78| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 7
...
$C$RL9:    ; CALL OCCURS {_SEM_pend} {0}     ; |92| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 8
...
$C$DW$77	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$77, DW_AT_TI_call
           CALL    .S2     B5                ; |93| 
           ADDKPC  .S2     $C$RL10,B3,3      ; |93| 

           MV      .L1     A10,A4            ; |93| 
||         MVK     .L2     0xffffffff,B4     ; |93| 

$C$RL10:   ; CALL OCCURS {_SEM_pend} {0}     ; |93| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 7
...
||         LDW     .D2T1   *++SP(8),A11      ; |96| 
	...
	.dwattr $C$DW$69, DW_AT_TI_end_line(0x60)
...
$C$DW$83	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$83, DW_AT_name("next")
	.dwattr $C$DW$83, DW_AT_TI_symbol_name("_next")
	.dwattr $C$DW$83, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr $C$DW$83, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$84	.dwtag  DW_TAG_member
	.dwattr $C$DW$84, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$84, DW_AT_name("prev")
	.dwattr $C$DW$84, DW_AT_TI_symbol_name("_prev")
...
$C$DW$85	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$85, DW_AT_name("wListElem")
	.dwattr $C$DW$85, DW_AT_TI_symbol_name("_wListElem")
	.dwattr $C$DW$85, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr $C$DW$85, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$86	.dwtag  DW_TAG_member
	.dwattr $C$DW$86, DW_AT_type(*$C$DW$T$22)
	.dwattr $C$DW$86, DW_AT_name("wCount")
	.dwattr $C$DW$86, DW_AT_TI_symbol_name("_wCount")
	.dwattr $C$DW$86, DW_AT_data_member_location[DW_OP_plus_uconst 0x8]
	.dwattr $C$DW$86, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$87	.dwtag  DW_TAG_member
	.dwattr $C$DW$87, DW_AT_type(*$C$DW$T$27)
	.dwattr $C$DW$87, DW_AT_name("fxn")
	.dwattr $C$DW$87, DW_AT_TI_symbol_name("_fxn")
...
$C$DW$88	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$88, DW_AT_name("job")
	.dwattr $C$DW$88, DW_AT_TI_symbol_name("_job")
	.dwattr $C$DW$88, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr $C$DW$88, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$89	.dwtag  DW_TAG_member
	.dwattr $C$DW$89, DW_AT_type(*$C$DW$T$22)
	.dwattr $C$DW$89, DW_AT_name("count")
	.dwattr $C$DW$89, DW_AT_TI_symbol_name("_count")
	.dwattr $C$DW$89, DW_AT_data_member_location[DW_OP_plus_uconst 0x10]
	.dwattr $C$DW$89, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$90	.dwtag  DW_TAG_member
	.dwattr $C$DW$90, DW_AT_type(*$C$DW$T$21)
	.dwattr $C$DW$90, DW_AT_name("pendQ")
	.dwattr $C$DW$90, DW_AT_TI_symbol_name("_pendQ")
	.dwattr $C$DW$90, DW_AT_data_member_location[DW_OP_plus_uconst 0x14]
	.dwattr $C$DW$90, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$91	.dwtag  DW_TAG_member
	.dwattr $C$DW$91, DW_AT_type(*$C$DW$T$32)
	.dwattr $C$DW$91, DW_AT_name("name")
	.dwattr $C$DW$91, DW_AT_TI_symbol_name("_name")
	.dwattr $C$DW$91, DW_AT_data_member_location[DW_OP_plus_uconst 0x1c]
...
$C$DW$92	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$92, DW_AT_name("dataBuf")
	.dwattr $C$DW$92, DW_AT_TI_symbol_name("_dataBuf")
	.dwattr $C$DW$92, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr $C$DW$92, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$93	.dwtag  DW_TAG_member
	.dwattr $C$DW$93, DW_AT_type(*$C$DW$T$36)
	.dwattr $C$DW$93, DW_AT_name("notifySemObj")
	.dwattr $C$DW$93, DW_AT_TI_symbol_name("_notifySemObj")
	.dwattr $C$DW$93, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr $C$DW$93, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$94	.dwtag  DW_TAG_member
	.dwattr $C$DW$94, DW_AT_type(*$C$DW$T$37)
	.dwattr $C$DW$94, DW_AT_name("bufferSize")
	.dwattr $C$DW$94, DW_AT_TI_symbol_name("_bufferSize")
...
$C$DW$95	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A0")
	.dwattr $C$DW$95, DW_AT_location[DW_OP_reg0]
$C$DW$96	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A1")
	.dwattr $C$DW$96, DW_AT_location[DW_OP_reg1]
$C$DW$97	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A2")
	.dwattr $C$DW$97, DW_AT_location[DW_OP_reg2]
$C$DW$98	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A3")
	.dwattr $C$DW$98, DW_AT_location[DW_OP_reg3]
$C$DW$99	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A4")
	.dwattr $C$DW$99, DW_AT_location[DW_OP_reg4]
$C$DW$100	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A5")
	.dwattr $C$DW$100, DW_AT_location[DW_OP_reg5]
$C$DW$101	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A6")
	.dwattr $C$DW$101, DW_AT_location[DW_OP_reg6]
$C$DW$102	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A7")
	.dwattr $C$DW$102, DW_AT_location[DW_OP_reg7]
$C$DW$103	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A8")
	.dwattr $C$DW$103, DW_AT_location[DW_OP_reg8]
$C$DW$104	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A9")
	.dwattr $C$DW$104, DW_AT_location[DW_OP_reg9]
$C$DW$105	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A10")
	.dwattr $C$DW$105, DW_AT_location[DW_OP_reg10]
$C$DW$106	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A11")
	.dwattr $C$DW$106, DW_AT_location[DW_OP_reg11]
$C$DW$107	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A12")
	.dwattr $C$DW$107, DW_AT_location[DW_OP_reg12]
$C$DW$108	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A13")
	.dwattr $C$DW$108, DW_AT_location[DW_OP_reg13]
$C$DW$109	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A14")
	.dwattr $C$DW$109, DW_AT_location[DW_OP_reg14]
$C$DW$110	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A15")
	.dwattr $C$DW$110, DW_AT_location[DW_OP_reg15]
$C$DW$111	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B0")
	.dwattr $C$DW$111, DW_AT_location[DW_OP_reg16]
$C$DW$112	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B1")
	.dwattr $C$DW$112, DW_AT_location[DW_OP_reg17]
$C$DW$113	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B2")
	.dwattr $C$DW$113, DW_AT_location[DW_OP_reg18]
$C$DW$114	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B3")
	.dwattr $C$DW$114, DW_AT_location[DW_OP_reg19]
$C$DW$115	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B4")
	.dwattr $C$DW$115, DW_AT_location[DW_OP_reg20]
$C$DW$116	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B5")
	.dwattr $C$DW$116, DW_AT_location[DW_OP_reg21]
$C$DW$117	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B6")
	.dwattr $C$DW$117, DW_AT_location[DW_OP_reg22]
$C$DW$118	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B7")
	.dwattr $C$DW$118, DW_AT_location[DW_OP_reg23]
$C$DW$119	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B8")
	.dwattr $C$DW$119, DW_AT_location[DW_OP_reg24]
$C$DW$120	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B9")
	.dwattr $C$DW$120, DW_AT_location[DW_OP_reg25]
$C$DW$121	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B10")
	.dwattr $C$DW$121, DW_AT_location[DW_OP_reg26]
$C$DW$122	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B11")
	.dwattr $C$DW$122, DW_AT_location[DW_OP_reg27]
$C$DW$123	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B12")
	.dwattr $C$DW$123, DW_AT_location[DW_OP_reg28]
$C$DW$124	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B13")
	.dwattr $C$DW$124, DW_AT_location[DW_OP_reg29]
$C$DW$125	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("DP")
...
$C$DW$129	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("IRP")
	.dwattr $C$DW$129, DW_AT_location[DW_OP_regx 0x22]
$C$DW$130	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("IFR")
	.dwattr $C$DW$130, DW_AT_location[DW_OP_regx 0x23]
$C$DW$131	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("NRP")
	.dwattr $C$DW$131, DW_AT_location[DW_OP_regx 0x24]
$C$DW$132	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A16")
	.dwattr $C$DW$132, DW_AT_location[DW_OP_regx 0x25]
$C$DW$133	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A17")
	.dwattr $C$DW$133, DW_AT_location[DW_OP_regx 0x26]
$C$DW$134	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A18")
	.dwattr $C$DW$134, DW_AT_location[DW_OP_regx 0x27]
$C$DW$135	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A19")
	.dwattr $C$DW$135, DW_AT_location[DW_OP_regx 0x28]
$C$DW$136	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A20")
	.dwattr $C$DW$136, DW_AT_location[DW_OP_regx 0x29]
$C$DW$137	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A21")
	.dwattr $C$DW$137, DW_AT_location[DW_OP_regx 0x2a]
$C$DW$138	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A22")
	.dwattr $C$DW$138, DW_AT_location[DW_OP_regx 0x2b]
$C$DW$139	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A23")
	.dwattr $C$DW$139, DW_AT_location[DW_OP_regx 0x2c]
$C$DW$140	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A24")
	.dwattr $C$DW$140, DW_AT_location[DW_OP_regx 0x2d]
$C$DW$141	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A25")
	.dwattr $C$DW$141, DW_AT_location[DW_OP_regx 0x2e]
$C$DW$142	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A26")
	.dwattr $C$DW$142, DW_AT_location[DW_OP_regx 0x2f]
$C$DW$143	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A27")
	.dwattr $C$DW$143, DW_AT_location[DW_OP_regx 0x30]
$C$DW$144	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A28")
	.dwattr $C$DW$144, DW_AT_location[DW_OP_regx 0x31]
$C$DW$145	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A29")
	.dwattr $C$DW$145, DW_AT_location[DW_OP_regx 0x32]
$C$DW$146	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A30")
	.dwattr $C$DW$146, DW_AT_location[DW_OP_regx 0x33]
$C$DW$147	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("A31")
	.dwattr $C$DW$147, DW_AT_location[DW_OP_regx 0x34]
$C$DW$148	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B16")
	.dwattr $C$DW$148, DW_AT_location[DW_OP_regx 0x35]
$C$DW$149	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B17")
	.dwattr $C$DW$149, DW_AT_location[DW_OP_regx 0x36]
$C$DW$150	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B18")
	.dwattr $C$DW$150, DW_AT_location[DW_OP_regx 0x37]
$C$DW$151	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B19")
	.dwattr $C$DW$151, DW_AT_location[DW_OP_regx 0x38]
$C$DW$152	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B20")
	.dwattr $C$DW$152, DW_AT_location[DW_OP_regx 0x39]
$C$DW$153	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B21")
	.dwattr $C$DW$153, DW_AT_location[DW_OP_regx 0x3a]
$C$DW$154	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B22")
	.dwattr $C$DW$154, DW_AT_location[DW_OP_regx 0x3b]
$C$DW$155	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B23")
	.dwattr $C$DW$155, DW_AT_location[DW_OP_regx 0x3c]
$C$DW$156	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B24")
	.dwattr $C$DW$156, DW_AT_location[DW_OP_regx 0x3d]
$C$DW$157	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B25")
	.dwattr $C$DW$157, DW_AT_location[DW_OP_regx 0x3e]
$C$DW$158	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B26")
	.dwattr $C$DW$158, DW_AT_location[DW_OP_regx 0x3f]
$C$DW$159	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B27")
	.dwattr $C$DW$159, DW_AT_location[DW_OP_regx 0x40]
$C$DW$160	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B28")
	.dwattr $C$DW$160, DW_AT_location[DW_OP_regx 0x41]
$C$DW$161	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B29")
	.dwattr $C$DW$161, DW_AT_location[DW_OP_regx 0x42]
$C$DW$162	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B30")
	.dwattr $C$DW$162, DW_AT_location[DW_OP_regx 0x43]
$C$DW$163	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("B31")
	.dwattr $C$DW$163, DW_AT_location[DW_OP_regx 0x44]
$C$DW$164	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("AMR")
	.dwattr $C$DW$164, DW_AT_location[DW_OP_regx 0x45]
$C$DW$165	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("CSR")
	.dwattr $C$DW$165, DW_AT_location[DW_OP_regx 0x46]
$C$DW$166	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("ISR")
	.dwattr $C$DW$166, DW_AT_location[DW_OP_regx 0x47]
$C$DW$167	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("ICR")
...
$C$DW$169	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("ISTP")
	.dwattr $C$DW$169, DW_AT_location[DW_OP_regx 0x4a]
$C$DW$170	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("IN")
	.dwattr $C$DW$170, DW_AT_location[DW_OP_regx 0x4b]
$C$DW$171	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("OUT")
	.dwattr $C$DW$171, DW_AT_location[DW_OP_regx 0x4c]
$C$DW$172	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("ACR")
	.dwattr $C$DW$172, DW_AT_location[DW_OP_regx 0x4d]
$C$DW$173	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("ADR")
	.dwattr $C$DW$173, DW_AT_location[DW_OP_regx 0x4e]
$C$DW$174	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("FADCR")
	.dwattr $C$DW$174, DW_AT_location[DW_OP_regx 0x4f]
$C$DW$175	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("FAUCR")
	.dwattr $C$DW$175, DW_AT_location[DW_OP_regx 0x50]
$C$DW$176	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("FMCR")
	.dwattr $C$DW$176, DW_AT_location[DW_OP_regx 0x51]
$C$DW$177	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("GFPGFR")
	.dwattr $C$DW$177, DW_AT_location[DW_OP_regx 0x52]
$C$DW$178	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("DIER")
	.dwattr $C$DW$178, DW_AT_location[DW_OP_regx 0x53]
$C$DW$179	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("REP")
	.dwattr $C$DW$179, DW_AT_location[DW_OP_regx 0x54]
$C$DW$180	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("TSCL")
	.dwattr $C$DW$180, DW_AT_location[DW_OP_regx 0x55]
$C$DW$181	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("TSCH")
	.dwattr $C$DW$181, DW_AT_location[DW_OP_regx 0x56]
$C$DW$182	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("ARP")
	.dwattr $C$DW$182, DW_AT_location[DW_OP_regx 0x57]
$C$DW$183	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("ILC")
	.dwattr $C$DW$183, DW_AT_location[DW_OP_regx 0x58]
$C$DW$184	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("RILC")
	.dwattr $C$DW$184, DW_AT_location[DW_OP_regx 0x59]
$C$DW$185	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("DNUM")
	.dwattr $C$DW$185, DW_AT_location[DW_OP_regx 0x5a]
$C$DW$186	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("SSR")
	.dwattr $C$DW$186, DW_AT_location[DW_OP_regx 0x5b]
$C$DW$187	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("GPLYA")
	.dwattr $C$DW$187, DW_AT_location[DW_OP_regx 0x5c]
$C$DW$188	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("GPLYB")
	.dwattr $C$DW$188, DW_AT_location[DW_OP_regx 0x5d]
$C$DW$189	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("TSR")
	.dwattr $C$DW$189, DW_AT_location[DW_OP_regx 0x5e]
$C$DW$190	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("ITSR")
	.dwattr $C$DW$190, DW_AT_location[DW_OP_regx 0x5f]
$C$DW$191	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("NTSR")
	.dwattr $C$DW$191, DW_AT_location[DW_OP_regx 0x60]
$C$DW$192	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("EFR")
	.dwattr $C$DW$192, DW_AT_location[DW_OP_regx 0x61]
$C$DW$193	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("ECR")
	.dwattr $C$DW$193, DW_AT_location[DW_OP_regx 0x62]
$C$DW$194	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("IERR")
	.dwattr $C$DW$194, DW_AT_location[DW_OP_regx 0x63]
$C$DW$195	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("DMSG")
	.dwattr $C$DW$195, DW_AT_location[DW_OP_regx 0x64]
$C$DW$196	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("CMSG")
	.dwattr $C$DW$196, DW_AT_location[DW_OP_regx 0x65]
$C$DW$197	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("DT_DMA_ADDR")
	.dwattr $C$DW$197, DW_AT_location[DW_OP_regx 0x66]
$C$DW$198	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("DT_DMA_DATA")
	.dwattr $C$DW$198, DW_AT_location[DW_OP_regx 0x67]
$C$DW$199	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("DT_DMA_CNTL")
	.dwattr $C$DW$199, DW_AT_location[DW_OP_regx 0x68]
$C$DW$200	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("TCU_CNTL")
	.dwattr $C$DW$200, DW_AT_location[DW_OP_regx 0x69]
$C$DW$201	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("RTDX_REC_CNTL")
	.dwattr $C$DW$201, DW_AT_location[DW_OP_regx 0x6a]
$C$DW$202	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("RTDX_XMT_CNTL")
	.dwattr $C$DW$202, DW_AT_location[DW_OP_regx 0x6b]
$C$DW$203	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("RTDX_CFG")
	.dwattr $C$DW$203, DW_AT_location[DW_OP_regx 0x6c]
$C$DW$204	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("RTDX_RDATA")
	.dwattr $C$DW$204, DW_AT_location[DW_OP_regx 0x6d]
$C$DW$205	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("RTDX_WDATA")
	.dwattr $C$DW$205, DW_AT_location[DW_OP_regx 0x6e]
$C$DW$206	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("RTDX_RADDR")
	.dwattr $C$DW$206, DW_AT_location[DW_OP_regx 0x6f]
$C$DW$207	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("RTDX_WADDR")
	.dwattr $C$DW$207, DW_AT_location[DW_OP_regx 0x70]
$C$DW$208	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("MFREG0")
	.dwattr $C$DW$208, DW_AT_location[DW_OP_regx 0x71]
$C$DW$209	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("DBG_STAT")
	.dwattr $C$DW$209, DW_AT_location[DW_OP_regx 0x72]
$C$DW$210	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("BRK_EN")
	.dwattr $C$DW$210, DW_AT_location[DW_OP_regx 0x73]
$C$DW$211	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("HWBP0_CNT")
	.dwattr $C$DW$211, DW_AT_location[DW_OP_regx 0x74]
$C$DW$212	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("HWBP0")
	.dwattr $C$DW$212, DW_AT_location[DW_OP_regx 0x75]
$C$DW$213	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("HWBP1")
	.dwattr $C$DW$213, DW_AT_location[DW_OP_regx 0x76]
$C$DW$214	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("HWBP2")
	.dwattr $C$DW$214, DW_AT_location[DW_OP_regx 0x77]
$C$DW$215	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("HWBP3")
	.dwattr $C$DW$215, DW_AT_location[DW_OP_regx 0x78]
$C$DW$216	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("OVERLAY")
	.dwattr $C$DW$216, DW_AT_location[DW_OP_regx 0x79]
$C$DW$217	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("PC_PROF")
	.dwattr $C$DW$217, DW_AT_location[DW_OP_regx 0x7a]
$C$DW$218	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("ATSR")
	.dwattr $C$DW$218, DW_AT_location[DW_OP_regx 0x7b]
$C$DW$219	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("TRR")
	.dwattr $C$DW$219, DW_AT_location[DW_OP_regx 0x7c]
$C$DW$220	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("TCRR")
	.dwattr $C$DW$220, DW_AT_location[DW_OP_regx 0x7d]
$C$DW$221	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("DESR")
	.dwattr $C$DW$221, DW_AT_location[DW_OP_regx 0x7e]
$C$DW$222	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("DETR")
	.dwattr $C$DW$222, DW_AT_location[DW_OP_regx 0x7f]
$C$DW$223	.dwtag  DW_TAG_TI_assign_register, DW_AT_name("CIE_RETA")
	.dwattr $C$DW$223, DW_AT_location[DW_OP_regx 0xe4]
	.dwendtag $C$DW$CU
